  ...
  <div className="relative group">
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      <a className="block relative rounded overflow-hidden">
        <img alt="ecommerce" style={{ margin: 'auto' }} className="md:mx-0 h-[30vh] md:h-[36vh] block" src="https://m.media-amazon.com/images/I/31-0mV3xzVL._SY300_SX300_QL70_FMwebp_.jpg" />
      </a>
