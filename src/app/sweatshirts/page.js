...
async function fetchData() {
  ...
  let products = await Product.find({category:'sweatShirts'});
  let sweatShirts = {};
  ...
  return (
    ...
    >
      <div className="container mx-auto py-12 px-4">
        {/* <h1 className="text-3xl font-bold text-center mb-8">Featured sweatShirts</h1> */}
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mx-auto">
          {Object.keys(products).length ===0 && <p>Sorry all SweatShirts are out of stock.Stay Tuned</p>}
